...
A: 1. Create component in `src/pages/NewPage/index.jsx` 2. Add route in `src/App.jsx` 3. Add sidebar link if needed

**Q: How do I add a new translation?**
A: 1. Add key to `src/i18n/locales/zh-CN.json` 2. Run `bun run i18n:sync` to sync to other languages 3. Translate the key in other locale files
