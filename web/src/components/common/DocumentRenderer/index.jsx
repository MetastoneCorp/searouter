...
const DocumentRenderer = ({ apiEndpoint, title, cacheKey, emptyMessage }) => {
  ...
  if (!content || content.trim() === '') {
    return (
      <div className='flex justify-center items-center flex-1 mt-14 bg-gray-50'>
        <Empty
  ...
  if (isUrl(content)) {
    return (
      <div className='flex justify-center items-center flex-1 mt-14 bg-gray-50 p-4'>
  ...
  if (isHtmlContent(content)) {
    return (
      <div className='flex-1 mt-14 bg-gray-50'>
